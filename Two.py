...
for Sell_Dist in range((Sell_Dist_input)[0], (Sell_Dist_input)[1]+1, 1):
	...
	fig_dict[Sell_Dist].update_layout(title = Sell_Dist, height = 900, hovermode = "x", hoverlabel=dict(font_color = "white",font_size=11, font_family="Lucida Sans Typewriter"))
